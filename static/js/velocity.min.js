...
!function (e) {
    ...
    return function (e, t, r, a) {
        ...
        }, animate: null, hook: null, mock: !1, version: {major: 1, minor: 0, patch: 0}, debug: !1};
        ...
        var S = function () {
                    ...
                    if ("scroll" === A) {
                        ...
                        for (var z in b) {
                            ...
                            if (i(o).isSVG || x.Names.prefixCheck(W)[1] !== !1 || x.Normalizations.registered[W] !== a) {
                                ...
                                l[z] = {rootPropertyValue: B, startValue: I, currentValue: I, endValue: R, unitType: D, easing: M}, v.debug && console.log("tweensContainer (" + z + "): " + JSON.stringify(l[z]), o)
            ...
            if (g.isWrapped(this) ? (f = !1, m = 0, h = this, d = this) : (f = !0, m = 1, h = l ? arguments[0].elements : arguments[0]), h = o(h)) {
                ...
                var L = {lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null}, O = [];
                $.each(h, function (e, t) {
                    g.isNode(t) && s.call(t)
                });
