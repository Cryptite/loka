/* Loka Talent Calculator
 Forked from dpatti's league-mastery-calc: https://github.com/dpatti/league-mastery-calc/
 */
var treeNames = [
    "offense",
    "defense",
...
function masteryTier(tree, index) {
    return Math.floor((data[tree][index].index - 1) / 2);
}

function masteryPointReq(tree, index) {
    return masteryTier(tree, index);
}
